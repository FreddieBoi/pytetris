...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "pytetris.py"
 
        #Name of program
        self.project_name = "pytetris"
 
        #Project url
        self.project_url = "https://github.com/FreddieBoi/pytetris"
 
        #Version of program
        self.project_version = "1.2b"
 
        #License of the program
        self.license = "Not really"
 
        #Auhor of program
        self.author_name = "Freddie Pettersson"
        self.author_email = "freddieboi@gmail.com"
        self.copyright = "Copyriot"
 
        #Description
        self.project_description = "pytetris is a Tetris clone written in python and pygame"
